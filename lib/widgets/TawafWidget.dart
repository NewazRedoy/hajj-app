...
class TawafWidget extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (count == 1) {
      ...
      canvas.drawArc(
          Rect.fromCircle(center: center, radius: radius + scale), 2 * pi * 0.17, -angle, false, completeArcPaint);
    } else if (count == 2) {
      ...
      canvas.drawArc(
          Rect.fromCircle(center: center, radius: radius + scale * 2), 2 * pi * 0.17, -angle, false, completeArcPaint);
    } else if (count == 3) {
      canvas.drawCircle(center, radius + scale, completeArcPaint);
      ...
      canvas.drawArc(
          Rect.fromCircle(center: center, radius: radius + scale * 3), 2 * pi * 0.17, -angle, false, completeArcPaint);
    } else if (count == 4) {
      canvas.drawCircle(center, radius + scale, completeArcPaint);
      canvas.drawCircle(center, radius + scale * 2, completeArcPaint);
      ...
      canvas.drawArc(
          Rect.fromCircle(center: center, radius: radius + scale * 4), 2 * pi * 0.17, -angle, false, completeArcPaint);
    } else if (count == 5) {
      canvas.drawCircle(center, radius + scale, completeArcPaint);
      canvas.drawCircle(center, radius + scale * 2, completeArcPaint);
      canvas.drawCircle(center, radius + scale * 3, completeArcPaint);
      ...
      canvas.drawArc(
          Rect.fromCircle(center: center, radius: radius + scale * 5), 2 * pi * 0.17, -angle, false, completeArcPaint);
    } else if (count == 6) {
      canvas.drawCircle(center, radius + scale, completeArcPaint);
      canvas.drawCircle(center, radius + scale * 2, completeArcPaint);
      canvas.drawCircle(center, radius + scale * 3, completeArcPaint);
      ...
      canvas.drawArc(
          Rect.fromCircle(center: center, radius: radius + scale * 6), 2 * pi * 0.17, -angle, false, completeArcPaint);
    } else if (count == 7) {
      canvas.drawCircle(center, radius + scale, completeArcPaint);
      canvas.drawCircle(center, radius + scale * 2, completeArcPaint);
      canvas.drawCircle(center, radius + scale * 3, completeArcPaint);
      ...
      canvas.drawArc(
          Rect.fromCircle(center: center, radius: radius + scale * 7), 2 * pi * 0.17, -angle, false, completeArcPaint);
    }

    //makam ibrahim
    canvas.drawCircle(
        center.translate(scale * 4, 0),
        3,
        Paint()
          ..strokeWidth = 2
    ...
    //prayerArea
    canvas.drawArc(
        Rect.fromCircle(center: center.translate(0, -scale), radius: scale * 2),
        pi,
        2 * pi * 0.5,
        false,
        Paint()
