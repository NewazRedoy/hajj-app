...
class QuranArabicUtils {
    ...
    static bool containArabic(String s) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            // non-reshaped arabic
            if ((current >= 1570) && (current <= 1610)) return true;

                // re-shaped arabic
            else if ((current >= 65133) && (current <= 65276)) return true;
    ...
    static List<TextSpan> highlightArabic(String source) {
        ...
        var style = TextStyle( color: Colors.red, fontFamily: FontFamily.arabic,);
