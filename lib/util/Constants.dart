...
class Constants {
  ...
  static List topics = [
    ...
    Topic(topic_id: 9, name: 'তাওয়াফ গণনা', color: '#409c3e'),
    Topic(topic_id: 10, name: "সা'ঈ গণনা", color: '#409c3e'),
    Topic(topic_id: 11, name: 'রিয়াল- টাকা কানভার্টার', color: '#409c3e'),
    Topic(topic_id: 12, name: 'কিছু আরবী বাক্য', color: '#409c3e'),
  ];
